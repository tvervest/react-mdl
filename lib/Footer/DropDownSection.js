...
var DropDownSection = function DropDownSection(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { className: 'mdl-' + size + '-footer__heading-checkbox', type: 'checkbox', defaultChecked: true, __self: undefined
        }),
        _react2.default.createElement(
            'h1',
            { className: 'mdl-' + size + '-footer__heading', __self: undefined
            },
            title
        ),
