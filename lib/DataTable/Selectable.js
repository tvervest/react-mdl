        ...
        _createClass(Selectable, [{
            ...
            value: function render() {
                ...
                return _react2.default.createElement(
                    Component,
                    _extends({ rows: realRows }, otherProps, { rowKeyColumn: rowKeyColumn, __self: this
                    }),
                    selectable && _react2.default.createElement(
                        _TableHeader2.default,
                        { name: 'mdl-header-select', cellFormatter: this.builRowCheckbox, __self: this
                        },
                        _react2.default.createElement(_Checkbox2.default, { className: 'mdl-data-table__select', checked: this.state.headerSelected, onChange: this.handleChangeHeaderCheckbox, __self: this
                        })
                    ),
                    children
                );
