    ...
    _createClass(Textfield, [{
        ...
        value: function render() {
            ...
            var labelContainer = _react2.default.createElement(
                'label',
                { className: 'mdl-textfield__label', htmlFor: customId, __self: this
                },
                label
            );
            var errorContainer = !!error && _react2.default.createElement(
                'span',
                { className: 'mdl-textfield__error', __self: this
                },
                error
            );
            ...
            return expandable ? _react2.default.createElement(
                'div',
                { className: containerClasses, style: style, __self: this
                },
                _react2.default.createElement(
                    'label',
                    { className: 'mdl-button mdl-js-button mdl-button--icon', htmlFor: customId, __self: this
                    },
                    _react2.default.createElement(
                        'i',
                        { className: 'material-icons', __self: this
                        },
                        expandableIcon
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'mdl-textfield__expandable-holder', __self: this
                    },
                    input,
                    labelContainer,
                    errorContainer
